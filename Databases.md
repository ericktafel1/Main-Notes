...
```shell
6165@htb[/htb]$ sudo service postgresql status
...
```shell
6165@htb[/htb]$ sudo systemctl start postgresql
```
...
```shell
6165@htb[/htb]$ sudo msfdb status
...
```shell
6165@htb[/htb]$ msfdb reinit
6165@htb[/htb]$ cp /usr/share/metasploit-framework/config/database.yml ~/.msf4/
6165@htb[/htb]$ sudo service postgresql restart
6165@htb[/htb]$ msfconsole -q
