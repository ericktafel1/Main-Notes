...
## ASPX and a Quick Learning Tip #aspx
...
```shell
6165@htb[/htb]$ ls /usr/share/nishang/Antak-WebShell
...
```shell
6165@htb[/htb]$ cp /usr/share/nishang/Antak-WebShell/antak.aspx /home/administrator/Upload.aspx
```
