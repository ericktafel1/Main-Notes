...
```shell
6165@htb[/htb]$ git clone https://github.com/darkoperator/Metasploit-Plugins
6165@htb[/htb]$ ls Metasploit-Plugins
...
```shell
6165@htb[/htb]$ sudo cp ./Metasploit-Plugins/pentest.rb /usr/share/metasploit-framework/plugins/pentest.rb
```
