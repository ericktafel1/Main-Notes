#go #assetfinder #amass #Httprobe #gowitness
...
Checks if domain is active by seeing if response code is returned.
...
Takes screenshots of domains.
```
gowitness single https://tesla.com
```

# Final Web Enumeration Script
